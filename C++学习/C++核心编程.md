...
| 打开方式        | 打开方式        | 解释            |     |
| ----------- | ----------- | ------------- | --- |
| ios::in     | ios::in     | 为读文件而打开文件     |     |
| ios::out    | ios::out    | 为写文件而打开文件     |     |
| ios::ate    | ios::ate    | 初始位置：文件尾      |     |
| ios::app    | ios::app    | 追加方式写文件       |     |
| ios::trunc  | ios::trunc  | 如果文件存在先删除，再创建 |     |
| ios::binary | ios::binary | 二进制方式         |     |
